...
// REACT TABLE FOR THE "OFFLINE ORDERS"
export default function OfflineOrders() {
  ...
  return (
    <div >
        ...
        <DataTable columns={columns} data={data} pagination={true} paginationPerPage={5} paginationRowsPerPageOptions={[ 5 , 10 ]} className={tablestyles.mytable}
        >
